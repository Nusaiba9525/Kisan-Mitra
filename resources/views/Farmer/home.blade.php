                ...
                <div class="row" style="background-image: linear-gradient(grey,white);">
                    <div class="col-lg-12">
                        <div class="nav flex-column nav-pills" id="tab" role="tablist" aria-orientation="vertical" style="padding:50px;">
                            <a class="nav-link active" id="home-tab" href="adminhome" role="tab">Home</a>
                            <a class="nav-link" id="product-tab" href="product" role="tab">Products Add</a>
                            <a class="nav-link" id="manage-tab" href="product" role="tab">Manage Out Items</a>
                            <a class="nav-link" id="payment-tab" href="product" role="tab">Payment</a>
                            <a class="nav-link" id="chat-tab" href="product" role="tab">Chat</a>
